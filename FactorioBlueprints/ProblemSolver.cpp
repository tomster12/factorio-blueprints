...
// - blueprint size
// - item recipes
// - and item inputs / outputs

// ProblemSolver
// - Unravels recipes to useful info
// - Calculating possible run configurations
...
namespace impl
{
	...
	void ProblemSolver::calculateRunConfigs()
	{
		...
		LOG(SOLVER, "Stage: calculateRunConfigs()\n"
			<< "=============================\n\n");
